...
class CheckoutPageWidget extends StatefulWidget {
  const CheckoutPageWidget({
    super.key,
    required this.cartPizza,
  });

  final CartPizzaRecord? cartPizza;
...
class _CheckoutPageWidgetState extends State<CheckoutPageWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<PizzasRecord>(
      stream: PizzasRecord.getDocument(widget!.cartPizza!.pizzaId!),
      builder: (context, snapshot) {
        ...
        final checkoutPagePizzasRecord = snapshot.data!;
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        functions
                                            .subtotal(
                                                widget!.cartPizza!.quantity,
                                                checkoutPagePizzasRecord.price
                                                    .toDouble())
                                            .toString(),
                      ...
                      var confirmDialogResponse = await showDialog<bool>(
                            ...
                            builder: (alertDialogContext) {
                              return AlertDialog(
                                ...
                                content: Text(
                                    'We will deliver soon your Pizza Lab soon..'),
                                actions: [
                                  TextButton(
